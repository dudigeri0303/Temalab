...
public record RestaurantDataDto(string? Id, string Name, string Description, string Label, string Location, string PhoneNumber, List<OpeningHourDto>? openingHours);
