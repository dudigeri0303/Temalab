        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfFreeSeats = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikedRestaurants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikedRestaurants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LikedRestaurants_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikedRestaurants_RestaurantId",
                table: "LikedRestaurants",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_LikedRestaurants_UserId",
                table: "LikedRestaurants",
                column: "UserId");
